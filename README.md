...
4. Choose this folder: `tab-organizer-extension`.

## Use

- Open a new tab to see the visual dashboard.
- Use search to find an open tab by title, site, or theme.
- Use the right-side search box to open a new website or Google search.
- Use quick links for common pages like Gmail, Drive, Docs, GitHub, and YouTube.
- Use the `Past 30 days` list to reopen frequently visited pages.
- Select a tab card to jump to it.
...
The dashboard groups tabs visually only; it does not create Chrome tab groups on the browser tab strip.
